    ...
    public class MySQLContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(new Product
            {
                ...
                Name = "Dinosauro refx",
                Price = new decimal(69.9),
                Description = "Um Dinosauro",
                ImageURL = "https://static.wikia.nocookie.net/parody/images/d/de/Char_12859.jpg/revision/latest/smart/width/250/height/250?cb=20160701005532",
                CategoryName = "T-shirt"
            });
            modelBuilder.Entity<Product>().HasData(new Product
            {
                Id = 15,
                Name = "boneco comprar você deve",
                Price = new decimal(69.9),
                Description = "Mandalorian",
                ImageURL = "https://m.media-amazon.com/images/I/81bhQsQ8aZL._AC_SL1500_.jpg",
                CategoryName = "T-shirt"
            });
        }
    }
