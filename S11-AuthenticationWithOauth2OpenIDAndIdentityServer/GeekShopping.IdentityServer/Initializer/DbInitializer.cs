    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                EmailConfirmed = true,
                PhoneNumber = "+55 (19) 99678-7668",
                FirstName = "Gabriel",
                LastName = "De Oliveira"
            };

            _user.CreateAsync(admin, "adm1n").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "adm1n").GetAwaiter().GetResult();
